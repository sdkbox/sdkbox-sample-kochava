...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginKochavaJS_PluginKochava_sendDeepLink(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 2) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginKochavaJS_PluginKochava_sendDeepLink : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginKochavaJS_PluginKochava_spatialEvent(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 4) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginKochavaJS_PluginKochava_spatialEvent : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginKochavaJS_PluginKochava_setLimitAdTracking(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginKochavaJS_PluginKochava_setLimitAdTracking : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginKochavaJS_PluginKochava_enableLogging(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginKochavaJS_PluginKochava_enableLogging : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginKochavaJS_PluginKochava_trackEvent(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 2) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginKochavaJS_PluginKochava_trackEvent : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginKochavaJS_PluginKochava_init(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    if (argc == 0) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginKochavaJS_PluginKochava_init : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginKochavaJS_PluginKochava_shutdown(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    if (argc == 0) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginKochavaJS_PluginKochava_shutdown : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
void js_register_PluginKochavaJS_PluginKochava(JSContext *cx, JS::HandleObject global) {
    ...
    jsb_sdkbox_PluginKochava_class = &PluginAgeCheq_class;
...
#if MOZJS_MAJOR_VERSION >= 52
    jsb_register_class<sdkbox::PluginKochava>(cx, jsb_sdkbox_PluginKochava_class, proto);
#else
    jsb_register_class<sdkbox::PluginKochava>(cx, jsb_sdkbox_PluginKochava_class, proto, JS::NullPtr());
#endif
#else
    ...
    JSString* jsstr = JS_NewStringCopyZ(cx, "PluginKochava");
